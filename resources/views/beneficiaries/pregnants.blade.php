...
<div class="flex h-screen overflow-hidden">
    ...
    <!-- Sidebar -->
    <aside class="bg-gradient-to-b from-red-300 via-red-500 to-red-800 text-white w-64 flex flex-col fixed inset-y-0">
        <div class="p-6">
    ...
    <!-- Main Content -->
    <main class="flex-1 ml-64 overflow-y-auto p-8 bg-gray-50">
        <div class="max-w-6xl mx-auto space-y-10">

                     <!-- Pregnant Women List -->
            <div class="bg-white rounded-xl shadow">
                <div class="flex flex-wrap justify-between items-center p-6 border-b gap-3">
                    ...
                    <div class="flex flex-wrap space-x-3 items-center">
                        ...
                        <!-- Import CSV button -->
                        <form method="POST" action="{{ route('pregnant.import') }}" enctype="multipart/form-data" class="inline">
                            @csrf
                        ...
                        <a href="{{ route('pregnant.template') }}" 
...
// 🟩 Filter + Search combined AJAX
$(document).ready(function(){
    function fetchPregnants() {
        var query = $('#searchPregnant').val();
    ...
    $('#searchPregnant').on('keyup', fetchPregnants);
    $('#filterPurok').on('change', fetchPregnants);
});
</script>
